...
def Constructor():
    """Event 0"""
    CommonFunc_TriggerEnemyAI_WithRegionOrRadius(0, character=Characters.Page0, region=1042342210, radius=15.0, seconds=0.0, animation_id=0)
    CommonFunc_TriggerEnemyAI_WithRegionOrRadius(0, character=Characters.Page1, region=1042342210, radius=5.0, seconds=1.0, animation_id=0)
