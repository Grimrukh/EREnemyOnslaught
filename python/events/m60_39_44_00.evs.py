...
def Constructor():
    ...
    CommonFunc_FieldBossMusicHealthBar(0, character=Characters.TibiaMariner, name=904950601, npc_threat_level=24)
    CommonFunc_NonRespawningBossWithReward(0, 1039440800, 0, 1039440800, 0, 30240, 0.0)
