...
def Constructor():
    ...
    CommonFunc_TriggerEnemyAI_WithRadius(0, character=Characters.PutridCorpse0, radius=0.0, seconds=0.0, animation_id=-1)
    CommonFunc_TriggerEnemyAI_WithRadius(0, character=Characters.PutridCorpse1, radius=0.0, seconds=0.0, animation_id=-1)
    CommonFunc_TriggerEnemyAI_WithRadius(0, character=Characters.PutridCorpse2, radius=0.0, seconds=0.0, animation_id=-1)
    CommonFunc_TriggerEnemyAI_WithRadius(0, character=Characters.PutridCorpse3, radius=0.0, seconds=0.0, animation_id=-1)
    CommonFunc_TriggerEnemyAI_WithRadius(0, character=Characters.PutridCorpse4, radius=0.0, seconds=0.0, animation_id=-1)
    Event_1049402390()
    CommonFunc_TriggerEnemyAI_WithRegion(0, character=Characters.Omenkiller, region=1049402381, seconds=0.0, animation_id=-1)
