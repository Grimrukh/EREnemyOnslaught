...
def Preconstructor():
    ...
    CommonFunc_TriggerEnemyAI_WithRegionOrRadius(0, character=Characters.Bat0, region=1041382200, radius=10.0, seconds=0.0, animation_id=-1)
    CommonFunc_TriggerEnemyAI_WithRegionOrRadius(0, character=Characters.Bat1, region=1041382200, radius=10.0, seconds=0.0, animation_id=-1)
    CommonFunc_TriggerEnemyAI_WithRegionOrRadius(0, 1041390202, 1041382200, 10.0, 0.0, -1)
