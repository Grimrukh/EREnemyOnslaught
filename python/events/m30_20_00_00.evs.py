...
def Event_30202829():
    ...
    CommonFunc_HostEntersBossFog(
        0,
        boss_dead_flag=30200800,
        fog_asset=Assets.AEG099_001_9000,
        fog_region=30202800,
        host_entered_fog_flag=30202805,
        boss_characters=30205800,
    ...
    CommonFunc_ControlBossFog(0, flag=30200800, fog_asset=Assets.AEG099_001_9000, model_point=3, first_time_done_flag=0)
