...
def Event_200():
    """Event 200"""
    CommonFunc_MausoleumAssetDestruction(0, mausoleum=Characters.WalkingMausoleum, asset_group=1036476420)
...
def Event_250():
    """Event 250"""
    CommonFunc_PrepareWalkingMausoleum(0, 1036470400, 1036471400, 1036471410, 1036471418)
