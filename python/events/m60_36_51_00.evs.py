...
def Preconstructor():
    ...
    CommonFunc_TriggerEnemyAI_WithRegion(0, character=Characters.DepravedPerfumer, region=1036512300, seconds=0.0, animation_id=-1)
    CommonFunc_TriggerEnemyAI_WithRegion(0, character=Characters.DepravedPerfumer, region=1036512301, seconds=0.0, animation_id=-1)
    Event_1036512300()
