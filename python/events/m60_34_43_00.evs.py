...
def Constructor():
    ...
    CommonFunc_NonRespawningWithReward(0, dead_flag=1034430310, character=Characters.Scarab, item_lot=40260, reward_delay=0.0, skip_reward=0)
