...
from .m14_00_00_00_entities import *
...
def Constructor():
    ...
    # Grace is moved outside Rennala fight and made permanent.
    ...
    Event_14002849()
    Event_140028121()
    Event_140028122(0, rennala_phase_2=Characters.RennalaBossPhase2, special_effect=14585, special_effect_1=14575)
    Event_140028122(1, rennala_phase_2=Characters.RennalaBossPhase2Clone, special_effect=14585, special_effect_1=14575)
    Event_14002606()
    Event_14002689()
    ...
    Event_14003801(
        0,
        14003800,
        Characters.RennalaBossPhase1,
        CharacterGroups.Sweetlings,
        Characters.Sweetling1,
        Characters.Sweetling2,
        Characters.Sweetling3,
        Characters.Sweetling4,
        Characters.Sweetling5,
        Characters.Sweetling6,
        Characters.Sweetling7,
        Characters.Sweetling8,
        Characters.Sweetling9,
        Characters.Sweetling10,
        Characters.Sweetling11,
        Characters.Sweetling12,
        Characters.Sweetling13,
        Characters.Sweetling14,
        Characters.Sweetling15,
        Characters.Sweetling16,
        Characters.Sweetling17,
        Characters.Sweetling18,
        Characters.Sweetling19,
        Characters.Sweetling20,
        Characters.Sweetling21,
        Characters.Sweetling22,
        Characters.Sweetling23,
        Characters.Sweetling24,
    )
    Event_14003825(0, flag=14003800, rennala=Characters.RennalaBossPhase1, sweetlings=CharacterGroups.Sweetlings)
    Event_14003805(0, flag=14003806, rennala=Characters.RennalaBossPhase1, sweetlings=CharacterGroups.Sweetlings, character_2=14005811)
    Event_14003807(0, rennala=Characters.RennalaBossPhase1, sweetlings=CharacterGroups.Sweetlings)
    Event_14003808(0, flag=14003800, rennala=Characters.RennalaBossPhase1)
    Event_14003817(0, sweetlings=CharacterGroups.Sweetlings)
    Event_14003809(0, flag=14003810, character=Characters.RennalaBossPhase1)
    Event_14003811(
        0,
        flag=14003810,
        sweetlings=CharacterGroups.Sweetlings,
        sweetling_1=Characters.Sweetling1,
        sweetling_2=Characters.Sweetling2,
        sweetling_3=Characters.Sweetling3,
        sweetling_4=Characters.Sweetling4,
        sweetling_5=Characters.Sweetling5,
        sweetling_6=Characters.Sweetling6,
        sweetling_7=Characters.Sweetling7,
        sweetling_8=Characters.Sweetling8,
        sweetling_9=Characters.Sweetling9,
        sweetling_10=Characters.Sweetling10,
        sweetling_11=Characters.Sweetling11,
        sweetling_12=Characters.Sweetling12,
        sweetling_13=Characters.Sweetling13,
        sweetling_14=Characters.Sweetling14,
        sweetling_15=Characters.Sweetling15,
        sweetling_16=Characters.Sweetling16,
        sweetling_17=Characters.Sweetling17,
        sweetling_18=Characters.Sweetling18,
        sweetling_19=Characters.Sweetling19,
        sweetling_20=Characters.Sweetling20,
        sweetling_21=Characters.Sweetling21,
        sweetling_22=Characters.Sweetling22,
        sweetling_23=Characters.Sweetling23,
        sweetling_24=Characters.Sweetling24,
    )
    Event_14003814(0, destination=Characters.RennalaBossPhase1, character=14000805)
    Event_14003815(0, character=Characters.RennalaBossPhase1, anchor_entity=14000805)
    Event_14003892(0, character=Characters.RennalaBossPhase1, character_1=CharacterGroups.Sweetlings)
    Event_14003893(0, character=Characters.RennalaBossPhase1, character_1=CharacterGroups.Sweetlings)
    Event_14003894(0, character=Characters.RennalaBossPhase1, character_1=CharacterGroups.Sweetlings)
    ...
    Event_14003922(0, flag=14003920, character=Characters.RennalaBossPhase2, character_1=Characters.RennalaBloodhoundSummon)
    Event_14003923(0, flag=14003920, flag_1=14003921, character=Characters.RennalaBloodhoundSummon, character_1=Characters.RennalaBossPhase2)
    Event_14003924(0, flag=14003920, flag_1=14003921, character=Characters.RennalaBloodhoundSummon)
    Event_14003925(0, flag=14003920, character=Characters.RennalaBloodhoundSummon)
    Event_14003926(0, character=Characters.RennalaBloodhoundSummon)

    RennalaSummonsTroll(0, troll_summoned_flag=14003960, rennala=Characters.RennalaBossPhase2, troll=Characters.RennalaTrollSummon)
    RennalaDismissesTroll(0, troll_summoned_flag=14003960, troll_dismissed_flag=14003961, troll=Characters.RennalaTrollSummon, rennala=Characters.RennalaBossPhase2)
    ResetRennalaTrollSummonAbility(0, troll_summoned_flag=14003960, troll_dismissed_flag=14003961, rennala=Characters.RennalaTrollSummon)
    Event_14003965(0, troll_summoned_flag=14003960, troll=Characters.RennalaTrollSummon)
    Event_14003966(0, troll=Characters.RennalaTrollSummon)
    Event_14003937(
        0,
        flag=14003935,
        character=Characters.RennalaBossPhase2,
        character_1=Characters.RennalaWolfSummon1,
        character_2=Characters.RennalaWolfSummon2,
        character_3=Characters.RennalaWolfSummon3,
        character_4=Characters.RennalaWolfSummon4,
    )
    Event_14003938(
        0,
        flag=14003935,
        flag_1=14003936,
        character=Characters.RennalaWolfSummon1,
        character_1=Characters.RennalaWolfSummon2,
        character_2=Characters.RennalaWolfSummon3,
        character_3=Characters.RennalaWolfSummon4,
        character_4=Characters.RennalaBossPhase2,
    )
    Event_14003939(
        0,
        flag=14003935,
    ...
    Event_14003940(0, flag=14003935, wolf=Characters.RennalaWolfSummon1)
    Event_14003940(1, flag=14003935, wolf=Characters.RennalaWolfSummon2)
    Event_14003940(2, flag=14003935, wolf=Characters.RennalaWolfSummon3)
    Event_14003940(3, flag=14003935, wolf=Characters.RennalaWolfSummon4)
    Event_14003945(0, wolf=Characters.RennalaWolfSummon1)
    Event_14003945(1, wolf=Characters.RennalaWolfSummon2)
    Event_14003945(2, wolf=Characters.RennalaWolfSummon3)
    Event_14003945(3, wolf=Characters.RennalaWolfSummon4)
    Event_14003972(0, flag=14003970, character=Characters.RennalaBossPhase2, character_1=Characters.RennalaDragonSummon)
    Event_14003973(0, flag=14003970, flag_1=14003971, character=Characters.RennalaDragonSummon, character_1=Characters.RennalaBossPhase2)
    Event_14003974(0, flag=14003970, flag_1=14003971, character=Characters.RennalaDragonSummon)
    Event_14003975(0, flag=14003970, character=Characters.RennalaDragonSummon)
    Event_14003976(0, character=Characters.RennalaDragonSummon)
    Event_14003977(0, character=Characters.RennalaBossPhase2, character_1=14005820)
    DisableSpawnersWhenRennalaDies()
    KillRennalaGroupEntities()
...
def Event_14002800():
    ...
    Await(
        HealthValueLessThanOrEqual(Characters.RennalaBossPhase2, value=0)
        and HealthValueLessThanOrEqual(Characters.RennalaBossPhase2Clone, value=0)
    )

    Wait(4.0)
    PlaySoundEffect(14008000, 888880000, sound_type=SoundType.s_SFX)
    IfPlayerInOwnWorld(AND_2)
    IfCharacterDead(AND_2, Characters.RennalaBossPhase2)
    IfCharacterDead(AND_2, Characters.RennalaBossPhase2Clone)
    IfCharacterDoesNotHaveSpecialEffect(AND_2, PLAYER, 9646)
    IfConditionTrue(OR_2, input_condition=AND_2)
    IfFlagEnabled(OR_2, Flags.RennalaDefeated)
    IfConditionTrue(MAIN, input_condition=OR_2)
    Kill(CharacterGroups.Sweetlings)
    KillBossAndDisplayBanner(character=Characters.RennalaBossPhase2, banner_type=BannerType.HollowArenaWin)
...
def Event_14002810():
    ...
    DisableCharacter(Characters.RennalaBossPhase2)
    DisableAnimations(Characters.RennalaBossPhase2)
    DisableCharacter(Characters.RennalaBossPhase2Clone)
    DisableAnimations(Characters.RennalaBossPhase2Clone)
    DisableObjectActivation(14001606, obj_act_id=199630)
    ...
    # TODO: Handle cloned students?
    Unknown_2004_73(entity=Characters.Sweetling1, unk_4_8=0)
    Unknown_2004_73(entity=Characters.Sweetling2, unk_4_8=0)
    Unknown_2004_73(entity=Characters.Sweetling3, unk_4_8=0)
    Unknown_2004_73(entity=Characters.Sweetling4, unk_4_8=0)
    Unknown_2004_73(entity=Characters.Sweetling5, unk_4_8=0)
    Unknown_2004_73(entity=Characters.Sweetling6, unk_4_8=0)
    Unknown_2004_73(entity=Characters.Sweetling7, unk_4_8=0)
    Unknown_2004_73(entity=Characters.Sweetling8, unk_4_8=0)
    Unknown_2004_73(entity=Characters.Sweetling9, unk_4_8=0)
    Unknown_2004_73(entity=Characters.Sweetling10, unk_4_8=0)
    Unknown_2004_73(entity=Characters.Sweetling11, unk_4_8=0)
    Unknown_2004_73(entity=Characters.Sweetling12, unk_4_8=0)
    Unknown_2004_73(entity=Characters.Sweetling13, unk_4_8=0)
    Unknown_2004_73(entity=Characters.Sweetling14, unk_4_8=0)
    Unknown_2004_73(entity=Characters.Sweetling15, unk_4_8=0)
    Unknown_2004_73(entity=Characters.Sweetling16, unk_4_8=0)
    Unknown_2004_73(entity=Characters.Sweetling17, unk_4_8=0)
    Unknown_2004_73(entity=Characters.Sweetling18, unk_4_8=0)
    Unknown_2004_73(entity=Characters.Sweetling19, unk_4_8=0)
    Unknown_2004_73(entity=Characters.Sweetling20, unk_4_8=0)
    Unknown_2004_73(entity=Characters.Sweetling21, unk_4_8=0)
    Unknown_2004_73(entity=Characters.Sweetling22, unk_4_8=0)
    Unknown_2004_73(entity=Characters.Sweetling23, unk_4_8=0)
    Unknown_2004_73(entity=Characters.Sweetling24, unk_4_8=0)
    IfPlayerInOwnWorld(AND_1)
    IfCharacterInsideRegion(AND_1, character=PLAYER, region=14002801)
    IfConditionTrue(OR_1, input_condition=AND_1)
    IfAttackedWithDamageType(OR_1, attacked_entity=Characters.RennalaBossPhase1, attacker=PLAYER)
    IfAttackedWithDamageType(OR_1, attacked_entity=Characters.RennalaBossPhase1Clone, attacker=PLAYER)
    IfConditionTrue(MAIN, input_condition=OR_1)
    EnableFlag(9021)
    SkipLinesIfPlayerNotInOwnWorld(1)
    ...
    EnableNetworkFlag(Characters.RennalaBossPhase1)
    EnableCharacter(Characters.RennalaBossPhase1)
    EnableAnimations(Characters.RennalaBossPhase1)
    EnableCharacter(Characters.RennalaBossPhase1Clone)
    EnableAnimations(Characters.RennalaBossPhase1Clone)
    EnableCharacter(CharacterGroups.Sweetlings)
    EnableAnimations(CharacterGroups.Sweetlings)
    EndOfAnimation(obj=14001810, animation_id=0)
    EndOfAnimation(obj=14001811, animation_id=0)
    EndOfAnimation(obj=14001812, animation_id=0)
    EndOfAnimation(obj=14001813, animation_id=0)
    ...
    DefineLabel(2)
    EnableAI(14005800)
    SetNetworkUpdateRate(Characters.RennalaBossPhase1, is_fixed=True, update_rate=CharacterUpdateRate.Always)
    SetNetworkUpdateRate(Characters.RennalaBossPhase1Clone, is_fixed=True, update_rate=CharacterUpdateRate.Always)
    SetNetworkUpdateRate(CharacterGroups.Sweetlings, is_fixed=True, update_rate=CharacterUpdateRate.Unknown105)
    EnableBossHealthBar(Characters.RennalaBossPhase1, name=902030000)
    EnableBossHealthBar(Characters.RennalaBossPhase1Clone, name=902030010, bar_slot=1)


@RestartOnRest(14002811)
def Event_14002811():
    """Event 14002811"""
    EndIfFlagEnabled(Flags.RennalaDefeated)
    IfPlayerInOwnWorld(AND_1)
    IfCharacterDead(AND_1, Characters.RennalaBossPhase1)
    # IfCharacterDead(AND_1, Characters.RennalaBossPhase1Clone)  # TODO: can't be hurt yet
    IfConditionTrue(MAIN, input_condition=AND_1)
    EnableNetworkFlag(14002802)
    Unknown_2004_73(entity=Characters.RennalaBossPhase2, unk_4_8=0)
    Unknown_2004_73(entity=Characters.RennalaBossPhase2Clone, unk_4_8=0)
    EndOfAnimation(obj=14001810, animation_id=10)
    EndOfAnimation(obj=14001811, animation_id=10)
    EndOfAnimation(obj=14001812, animation_id=10)
    EndOfAnimation(obj=14001813, animation_id=10)
    ...
    SetBackreadStateAlternate(Characters.RennalaBossPhase2, True)
    SetBackreadStateAlternate(Characters.RennalaBossPhase2Clone, True)
    SkipLinesIfPlayerNotInOwnWorld(2)
    UnknownCutscene_11(
    ...
    # TODO: What are these? 14000106 is attached to 14001106 below. Maybe moon?
    Move(35000, destination=14002806, destination_type=CoordEntityType.Region, copy_draw_parent=Characters.RennalaBossPhase2)
    Move(14000106, destination=14002806, destination_type=CoordEntityType.Region, copy_draw_parent=Characters.RennalaBossPhase2)

    SetCharacterTalkRange(character=14000106, distance=200.0)
    Unknown_2003_68(unknown1=0, unknown2=-1.0, unknown3=0)
    EnableCharacter(Characters.RennalaBossPhase2)
    EnableCharacter(Characters.RennalaBossPhase2Clone)
    EnableAnimations(Characters.RennalaBossPhase2)
    EnableAnimations(Characters.RennalaBossPhase2Clone)
    ForceAnimation(Characters.RennalaBossPhase2, 20005, unknown2=1.0)
    ForceAnimation(Characters.RennalaBossPhase2Clone, 20005, unknown2=1.0)
    EnableBossHealthBar(Characters.RennalaBossPhase2, name=902030001)
    EnableBossHealthBar(Characters.RennalaBossPhase2Clone, name=902030010, bar_slot=1)
    SetNetworkUpdateRate(Characters.RennalaBossPhase2, is_fixed=True, update_rate=CharacterUpdateRate.Always)
    SetNetworkUpdateRate(Characters.RennalaBossPhase2Clone, is_fixed=True, update_rate=CharacterUpdateRate.Always)
    WaitFramesAfterCutscene(frames=1)
...
def Event_140028121():
    ...
    EndIfPlayerNotInOwnWorld()
    EndIfFlagEnabled(Flags.RennalaDefeated)
    IfCharacterHasSpecialEffect(OR_1, Characters.RennalaBossPhase1, 14350)
    IfConditionTrue(MAIN, input_condition=OR_1)
    EnableFlag(14002707)
    IfFlagDisabled(AND_1, 14002707)
    IfCharacterDoesNotHaveSpecialEffect(AND_1, Characters.RennalaBossPhase1, 14350)
    IfConditionTrue(MAIN, input_condition=AND_1)
    Restart()


@RestartOnRest(140028122)
def Event_140028122(_, rennala_phase_2: uint, special_effect: int, special_effect_1: int):
    """Event 140028122"""
    EndIfPlayerNotInOwnWorld()
    EndIfFlagEnabled(rennala_phase_2)
    IfCharacterHasSpecialEffect(OR_1, rennala_phase_2, special_effect)
    IfCharacterHasSpecialEffect(OR_1, rennala_phase_2, special_effect_1)
    IfConditionTrue(MAIN, input_condition=OR_1)
    GotoIfCharacterHasSpecialEffect(Label.L1, character=rennala_phase_2, special_effect=special_effect)
    GotoIfCharacterHasSpecialEffect(Label.L2, character=rennala_phase_2, special_effect=special_effect_1)
    ...
    IfCharacterDoesNotHaveSpecialEffect(AND_1, rennala_phase_2, special_effect)
    IfCharacterDoesNotHaveSpecialEffect(AND_1, rennala_phase_2, special_effect_1)
    IfConditionTrue(MAIN, input_condition=AND_1)
    Restart()
...
def Event_14002850():
    """Event 14002850"""
    EndIfFlagEnabled(Flags.RedWolfDead)

    Await(
        HealthRatioLessThanOrEqual(Characters.RedWolfOfRadagon, value=0.0)
        and HealthRatioLessThanOrEqual(Characters.RedWolfOfRadagonClone, value=0.0)
    )

    Wait(2.0)
    PlaySoundEffect(Characters.RedWolfOfRadagon, 77777777, sound_type=SoundType.s_SFX)

    Await(CharacterDead(Characters.RedWolfOfRadagon) and CharacterDead(Characters.RedWolfOfRadagonClone))

    KillBossAndDisplayBanner(character=Characters.RedWolfOfRadagon, banner_type=BannerType.Unknown)
...
def Event_14002860():
    ...
    DisableCharacter(Characters.RedWolfOfRadagon)
    DisableCharacter(Characters.RedWolfOfRadagonClone)
    DisableAnimations(Characters.RedWolfOfRadagon)
    DisableAnimations(Characters.RedWolfOfRadagonClone)
    Kill(Characters.RedWolfOfRadagon)
    Kill(Characters.RedWolfOfRadagonClone)
    End()

    # --- Label 0 --- #
    DefineLabel(0)
    DisableAI(Characters.RedWolfOfRadagon)
    DisableAI(Characters.RedWolfOfRadagonClone)
    GotoIfFlagEnabled(Label.L1, flag=14000851)
    ForceAnimation(Characters.RedWolfOfRadagon, 30002, loop=True, unknown2=1.0)
    ForceAnimation(Characters.RedWolfOfRadagonClone, 30002, loop=True, unknown2=1.0)
    IfFlagEnabled(AND_2, 14002855)
    IfCharacterInsideRegion(AND_2, character=PLAYER, region=14002850)
    IfConditionTrue(MAIN, input_condition=AND_2)
    EnableNetworkFlag(14000851)
    ForceAnimation(Characters.RedWolfOfRadagon, 20002, unknown2=1.0)
    ForceAnimation(Characters.RedWolfOfRadagonClone, 20002, unknown2=1.0)
    Goto(Label.L2)

    # --- Label 1 --- #
    DefineLabel(1)
    Move(Characters.RedWolfOfRadagon, destination=14002856, destination_type=CoordEntityType.Region, short_move=True)
    Move(Characters.RedWolfOfRadagonClone, destination=14002856, destination_type=CoordEntityType.Region, short_move=True)
    IfFlagEnabled(AND_2, 14002855)
    IfCharacterInsideRegion(AND_2, character=PLAYER, region=14002850)
    IfConditionTrue(MAIN, input_condition=AND_2)
    ...
    # --- Label 2 --- #
    DefineLabel(2)
    EnableAI(Characters.RedWolfOfRadagon)
    EnableAI(Characters.RedWolfOfRadagonClone)
    SetNetworkUpdateRate(14005850, is_fixed=True, update_rate=CharacterUpdateRate.Always)
    EnableBossHealthBar(Characters.RedWolfOfRadagon, name=903181000)
    EnableBossHealthBar(Characters.RedWolfOfRadagonClone, name=903181010, bar_slot=1)
    SkipLinesIfPlayerNotInOwnWorld(1)
...
def Event_14002820(_, character: uint):
    """Event 14002820: UNUSED"""
    DisableAI(character)
    IfCharacterInsideRegion(AND_1, character=20000, region=14002812)
    IfHasAIStatus(AND_1, Characters.Sweetling1, ai_status=AIStatusType.Battle)
    IfConditionTrue(MAIN, input_condition=AND_1)
    EnableAI(character)
    DisableObject(14001800)
    DisableObject(14006800)  # no longer includes Site of Grace; not sure if it includes other assets
    SetNetworkUpdateRate(Characters.RennalaBossPhase1, is_fixed=True, update_rate=CharacterUpdateRate.Always)
    EnableBossHealthBar(character)
    IfFlagEnabled(MAIN, 14002810)
    WaitFrames(frames=1)
    DisableBossHealthBar(Characters.RennalaBossPhase1)
    EnableBossHealthBar(character)
...
def Event_14002821(_, character: uint):
    ...
    IfConditionTrue(MAIN, input_condition=OR_1)
    SetNetworkUpdateRate(Characters.RennalaBossPhase1, is_fixed=False, update_rate=CharacterUpdateRate.Always)
    EnableAI(character)
    EnableBossHealthBar(character)
...
def Event_14003805(_, flag: uint, rennala: uint, sweetlings: uint, character_2: uint):
    """Event 14003805"""
    EndIfPlayerNotInOwnWorld()
    IfCharacterHasSpecialEffect(AND_1, rennala, 14356)
    IfCharacterHasSpecialEffect(AND_1, sweetlings, 14396, target_count=0.0)
    IfCharacterHasSpecialEffect(AND_1, sweetlings, 14394, target_count=0.0)
    IfFlagEnabled(AND_1, flag)
    IfConditionTrue(MAIN, input_condition=AND_1)
    GotoIfCharacterHasSpecialEffect(Label.L1, character=rennala, special_effect=14369)
    GotoIfCharacterHasSpecialEffect(Label.L0, character=rennala, special_effect=14368)
    RestartIfCharacterDoesNotHaveSpecialEffect(character=rennala, special_effect=14361)
    AddSpecialEffect(rennala, 14368)
    IfCharacterHasSpecialEffect(OR_15, sweetlings, 14394, target_comparison_type=ComparisonType.GreaterThanOrEqual)
    AwaitConditionTrue(OR_15)
    Restart()

    # --- Label 0 --- #
    DefineLabel(0)
    AddSpecialEffect(rennala, 14369)
    IfCharacterHasSpecialEffect(OR_15, sweetlings, 14394, target_comparison_type=ComparisonType.GreaterThanOrEqual)
    AwaitConditionTrue(OR_15)
    Restart()
    ...
    # --- Label 1 --- #
    DefineLabel(1)
    AddSpecialEffect(rennala, 14357)
    AddSpecialEffect(sweetlings, 14384)
    AddSpecialEffect(rennala, 14578)
    ReplanAI(rennala)
    EnableFlag(14003816)
    DisableFlag(14003800)
    AddSpecialEffect(sweetlings, 14388)
    AddSpecialEffect(character_2, 14388)
    Restart()


@RestartOnRest(14003807)
def Event_14003807(_, rennala: uint, sweetlings: uint):
    """Event 14003807"""
    EndIfPlayerNotInOwnWorld()
    IfCharacterHasSpecialEffect(AND_1, rennala, 14357)
    IfCharacterHasSpecialEffect(AND_1, rennala, 14358)
    IfCharacterHasSpecialEffect(AND_1, sweetlings, 14396, target_comparison_type=ComparisonType.GreaterThanOrEqual)
    IfConditionTrue(MAIN, input_condition=AND_1)
    AddSpecialEffect(rennala, 14356)
    AddSpecialEffect(sweetlings, 14589)
    DisableFlag(14003816)
    Restart()


@RestartOnRest(14003808)
def Event_14003808(_, flag: uint, rennala: uint):
    """Event 14003808"""
    EndIfPlayerNotInOwnWorld()
    IfCharacterHasSpecialEffect(AND_1, rennala, 14358)
    IfCharacterHasSpecialEffect(AND_1, rennala, 14357)
    ...
    Wait(10.0)
    EnableFlag(flag)
    IfCharacterHasSpecialEffect(OR_15, rennala, 14356)
...
def Event_14003811(
    ...
    # Randomly choose one of three Sweetling subsets.
    DisableFlag(14003802)
    DisableFlag(14003803)
    DisableFlag(14003804)
    EnableRandomFlagInRange(flag_range=(14003802, 14003804))
    ...
    SkipLinesIfCharacterDoesNotHaveSpecialEffect(line_count=7, character=sweetling_1, special_effect=14577)
    SkipLinesIfCharacterHasSpecialEffect(line_count=6, character=sweetling_1, special_effect=14351)
    SkipLinesIfCharacterHasSpecialEffect(line_count=5, character=sweetling_1, special_effect=14394)
    SkipLinesIfCharacterDoesNotHaveSpecialEffect(line_count=4, character=sweetling_1, special_effect=14393)
    AddSpecialEffect(sweetling_1, 14351)
    ReplanAI(sweetling_1)
    SetNetworkUpdateRate(sweetling_1, is_fixed=True, update_rate=CharacterUpdateRate.Always)
    Restart()
    SkipLinesIfCharacterDoesNotHaveSpecialEffect(line_count=7, character=sweetling_2, special_effect=14577)
    SkipLinesIfCharacterHasSpecialEffect(line_count=6, character=sweetling_2, special_effect=14351)
    SkipLinesIfCharacterHasSpecialEffect(line_count=5, character=sweetling_2, special_effect=14394)
    SkipLinesIfCharacterDoesNotHaveSpecialEffect(line_count=4, character=sweetling_2, special_effect=14393)
    AddSpecialEffect(sweetling_2, 14351)
    ReplanAI(sweetling_2)
    SetNetworkUpdateRate(sweetling_2, is_fixed=True, update_rate=CharacterUpdateRate.Always)
    Restart()
    SkipLinesIfCharacterDoesNotHaveSpecialEffect(line_count=7, character=sweetling_3, special_effect=14577)
    SkipLinesIfCharacterHasSpecialEffect(line_count=6, character=sweetling_3, special_effect=14351)
    SkipLinesIfCharacterHasSpecialEffect(line_count=5, character=sweetling_3, special_effect=14394)
    SkipLinesIfCharacterDoesNotHaveSpecialEffect(line_count=4, character=sweetling_3, special_effect=14393)
    AddSpecialEffect(sweetling_3, 14351)
    ReplanAI(sweetling_3)
    SetNetworkUpdateRate(sweetling_3, is_fixed=True, update_rate=CharacterUpdateRate.Always)
    Restart()
    SkipLinesIfCharacterDoesNotHaveSpecialEffect(line_count=7, character=sweetling_4, special_effect=14577)
    SkipLinesIfCharacterHasSpecialEffect(line_count=6, character=sweetling_4, special_effect=14351)
    SkipLinesIfCharacterHasSpecialEffect(line_count=5, character=sweetling_4, special_effect=14394)
    SkipLinesIfCharacterDoesNotHaveSpecialEffect(line_count=4, character=sweetling_4, special_effect=14393)
    AddSpecialEffect(sweetling_4, 14351)
    ReplanAI(sweetling_4)
    SetNetworkUpdateRate(sweetling_4, is_fixed=True, update_rate=CharacterUpdateRate.Always)
    Restart()
    SkipLinesIfCharacterDoesNotHaveSpecialEffect(line_count=7, character=sweetling_5, special_effect=14577)
    SkipLinesIfCharacterHasSpecialEffect(line_count=6, character=sweetling_5, special_effect=14351)
    SkipLinesIfCharacterHasSpecialEffect(line_count=5, character=sweetling_5, special_effect=14394)
    SkipLinesIfCharacterDoesNotHaveSpecialEffect(line_count=4, character=sweetling_5, special_effect=14393)
    AddSpecialEffect(sweetling_5, 14351)
    ReplanAI(sweetling_5)
    SetNetworkUpdateRate(sweetling_5, is_fixed=True, update_rate=CharacterUpdateRate.Always)
    Restart()
    SkipLinesIfCharacterDoesNotHaveSpecialEffect(line_count=7, character=sweetling_6, special_effect=14577)
    SkipLinesIfCharacterHasSpecialEffect(line_count=6, character=sweetling_6, special_effect=14351)
    SkipLinesIfCharacterHasSpecialEffect(line_count=5, character=sweetling_6, special_effect=14394)
    SkipLinesIfCharacterDoesNotHaveSpecialEffect(line_count=4, character=sweetling_6, special_effect=14393)
    AddSpecialEffect(sweetling_6, 14351)
    ReplanAI(sweetling_6)
    SetNetworkUpdateRate(sweetling_6, is_fixed=True, update_rate=CharacterUpdateRate.Always)
    Restart()
    SkipLinesIfCharacterDoesNotHaveSpecialEffect(line_count=7, character=sweetling_7, special_effect=14577)
    SkipLinesIfCharacterHasSpecialEffect(line_count=6, character=sweetling_7, special_effect=14351)
    SkipLinesIfCharacterHasSpecialEffect(line_count=5, character=sweetling_7, special_effect=14394)
    SkipLinesIfCharacterDoesNotHaveSpecialEffect(line_count=4, character=sweetling_7, special_effect=14393)
    AddSpecialEffect(sweetling_7, 14351)
    ReplanAI(sweetling_7)
    SetNetworkUpdateRate(sweetling_7, is_fixed=True, update_rate=CharacterUpdateRate.Always)
    Restart()
    SkipLinesIfCharacterDoesNotHaveSpecialEffect(line_count=7, character=sweetling_8, special_effect=14577)
    SkipLinesIfCharacterHasSpecialEffect(line_count=6, character=sweetling_8, special_effect=14351)
    SkipLinesIfCharacterHasSpecialEffect(line_count=5, character=sweetling_8, special_effect=14394)
    SkipLinesIfCharacterDoesNotHaveSpecialEffect(line_count=4, character=sweetling_8, special_effect=14393)
    AddSpecialEffect(sweetling_8, 14351)
    ReplanAI(sweetling_8)
    SetNetworkUpdateRate(sweetling_8, is_fixed=True, update_rate=CharacterUpdateRate.Always)
    Restart()

    # --- Label 0 --- #
    DefineLabel(0)
    SkipLinesIfCharacterDoesNotHaveSpecialEffect(line_count=7, character=sweetling_9, special_effect=14577)
    SkipLinesIfCharacterHasSpecialEffect(line_count=6, character=sweetling_9, special_effect=14351)
    SkipLinesIfCharacterHasSpecialEffect(line_count=5, character=sweetling_9, special_effect=14394)
    SkipLinesIfCharacterDoesNotHaveSpecialEffect(line_count=4, character=sweetling_9, special_effect=14393)
    AddSpecialEffect(sweetling_9, 14351)
    ReplanAI(sweetling_9)
    SetNetworkUpdateRate(sweetling_9, is_fixed=True, update_rate=CharacterUpdateRate.Always)
    Restart()
    SkipLinesIfCharacterDoesNotHaveSpecialEffect(line_count=7, character=sweetling_10, special_effect=14577)
    SkipLinesIfCharacterHasSpecialEffect(line_count=6, character=sweetling_10, special_effect=14351)
    SkipLinesIfCharacterHasSpecialEffect(line_count=5, character=sweetling_10, special_effect=14394)
    SkipLinesIfCharacterDoesNotHaveSpecialEffect(line_count=4, character=sweetling_10, special_effect=14393)
    AddSpecialEffect(sweetling_10, 14351)
    ReplanAI(sweetling_10)
    SetNetworkUpdateRate(sweetling_10, is_fixed=True, update_rate=CharacterUpdateRate.Always)
    Restart()
    SkipLinesIfCharacterDoesNotHaveSpecialEffect(line_count=7, character=sweetling_11, special_effect=14577)
    SkipLinesIfCharacterHasSpecialEffect(line_count=6, character=sweetling_11, special_effect=14351)
    SkipLinesIfCharacterHasSpecialEffect(line_count=5, character=sweetling_11, special_effect=14394)
    SkipLinesIfCharacterDoesNotHaveSpecialEffect(line_count=4, character=sweetling_11, special_effect=14393)
    AddSpecialEffect(sweetling_11, 14351)
    ReplanAI(sweetling_11)
    SetNetworkUpdateRate(sweetling_11, is_fixed=True, update_rate=CharacterUpdateRate.Always)
    Restart()
    SkipLinesIfCharacterDoesNotHaveSpecialEffect(line_count=7, character=sweetling_12, special_effect=14577)
    SkipLinesIfCharacterHasSpecialEffect(line_count=6, character=sweetling_12, special_effect=14351)
    SkipLinesIfCharacterHasSpecialEffect(line_count=5, character=sweetling_12, special_effect=14394)
    SkipLinesIfCharacterDoesNotHaveSpecialEffect(line_count=4, character=sweetling_12, special_effect=14393)
    AddSpecialEffect(sweetling_12, 14351)
    ReplanAI(sweetling_12)
    SetNetworkUpdateRate(sweetling_12, is_fixed=True, update_rate=CharacterUpdateRate.Always)
    Restart()
    SkipLinesIfCharacterDoesNotHaveSpecialEffect(line_count=7, character=sweetling_13, special_effect=14577)
    SkipLinesIfCharacterHasSpecialEffect(line_count=6, character=sweetling_13, special_effect=14351)
    SkipLinesIfCharacterHasSpecialEffect(line_count=5, character=sweetling_13, special_effect=14394)
    SkipLinesIfCharacterDoesNotHaveSpecialEffect(line_count=4, character=sweetling_13, special_effect=14393)
    AddSpecialEffect(sweetling_13, 14351)
    ReplanAI(sweetling_13)
    SetNetworkUpdateRate(sweetling_13, is_fixed=True, update_rate=CharacterUpdateRate.Always)
    Restart()
    SkipLinesIfCharacterDoesNotHaveSpecialEffect(line_count=7, character=sweetling_14, special_effect=14577)
    SkipLinesIfCharacterHasSpecialEffect(line_count=6, character=sweetling_14, special_effect=14351)
    SkipLinesIfCharacterHasSpecialEffect(line_count=5, character=sweetling_14, special_effect=14394)
    SkipLinesIfCharacterDoesNotHaveSpecialEffect(line_count=4, character=sweetling_14, special_effect=14393)
    AddSpecialEffect(sweetling_14, 14351)
    ReplanAI(sweetling_14)
    SetNetworkUpdateRate(sweetling_14, is_fixed=True, update_rate=CharacterUpdateRate.Always)
    Restart()
    SkipLinesIfCharacterDoesNotHaveSpecialEffect(line_count=7, character=sweetling_15, special_effect=14577)
    SkipLinesIfCharacterHasSpecialEffect(line_count=6, character=sweetling_15, special_effect=14351)
    SkipLinesIfCharacterHasSpecialEffect(line_count=5, character=sweetling_15, special_effect=14394)
    SkipLinesIfCharacterDoesNotHaveSpecialEffect(line_count=4, character=sweetling_15, special_effect=14393)
    AddSpecialEffect(sweetling_15, 14351)
    ReplanAI(sweetling_15)
    SetNetworkUpdateRate(sweetling_15, is_fixed=True, update_rate=CharacterUpdateRate.Always)
    Restart()
    SkipLinesIfCharacterDoesNotHaveSpecialEffect(line_count=7, character=sweetling_16, special_effect=14577)
    SkipLinesIfCharacterHasSpecialEffect(line_count=6, character=sweetling_16, special_effect=14351)
    SkipLinesIfCharacterHasSpecialEffect(line_count=5, character=sweetling_16, special_effect=14394)
    SkipLinesIfCharacterDoesNotHaveSpecialEffect(line_count=4, character=sweetling_16, special_effect=14393)
    AddSpecialEffect(sweetling_16, 14351)
    ReplanAI(sweetling_16)
    SetNetworkUpdateRate(sweetling_16, is_fixed=True, update_rate=CharacterUpdateRate.Always)
    Restart()

    # --- Label 1 --- #
    DefineLabel(1)
    SkipLinesIfCharacterDoesNotHaveSpecialEffect(line_count=7, character=sweetling_17, special_effect=14577)
    SkipLinesIfCharacterHasSpecialEffect(line_count=6, character=sweetling_17, special_effect=14351)
    SkipLinesIfCharacterHasSpecialEffect(line_count=5, character=sweetling_17, special_effect=14394)
    SkipLinesIfCharacterDoesNotHaveSpecialEffect(line_count=4, character=sweetling_17, special_effect=14393)
    AddSpecialEffect(sweetling_17, 14351)
    ReplanAI(sweetling_17)
    SetNetworkUpdateRate(sweetling_17, is_fixed=True, update_rate=CharacterUpdateRate.Always)
    Restart()
    SkipLinesIfCharacterDoesNotHaveSpecialEffect(line_count=7, character=sweetling_18, special_effect=14577)
    SkipLinesIfCharacterHasSpecialEffect(line_count=6, character=sweetling_18, special_effect=14351)
    SkipLinesIfCharacterHasSpecialEffect(line_count=5, character=sweetling_18, special_effect=14394)
    SkipLinesIfCharacterDoesNotHaveSpecialEffect(line_count=4, character=sweetling_18, special_effect=14393)
    AddSpecialEffect(sweetling_18, 14351)
    ReplanAI(sweetling_18)
    SetNetworkUpdateRate(sweetling_18, is_fixed=True, update_rate=CharacterUpdateRate.Always)
    Restart()
    Goto(Label.L10)
    SkipLinesIfCharacterDoesNotHaveSpecialEffect(line_count=7, character=sweetling_19, special_effect=14577)
    SkipLinesIfCharacterHasSpecialEffect(line_count=6, character=sweetling_19, special_effect=14351)
    SkipLinesIfCharacterHasSpecialEffect(line_count=5, character=sweetling_19, special_effect=14394)
    SkipLinesIfCharacterDoesNotHaveSpecialEffect(line_count=4, character=sweetling_19, special_effect=14393)
    AddSpecialEffect(sweetling_19, 14351)
    ReplanAI(sweetling_19)
    SetNetworkUpdateRate(sweetling_19, is_fixed=True, update_rate=CharacterUpdateRate.Always)
    Restart()
    SkipLinesIfCharacterDoesNotHaveSpecialEffect(line_count=7, character=sweetling_20, special_effect=14577)
    SkipLinesIfCharacterHasSpecialEffect(line_count=6, character=sweetling_20, special_effect=14351)
    SkipLinesIfCharacterHasSpecialEffect(line_count=5, character=sweetling_20, special_effect=14394)
    SkipLinesIfCharacterDoesNotHaveSpecialEffect(line_count=4, character=sweetling_20, special_effect=14393)
    AddSpecialEffect(sweetling_20, 14351)
    ReplanAI(sweetling_20)
    SetNetworkUpdateRate(sweetling_20, is_fixed=True, update_rate=CharacterUpdateRate.Always)
    Restart()
    SkipLinesIfCharacterDoesNotHaveSpecialEffect(line_count=7, character=sweetling_21, special_effect=14577)
    SkipLinesIfCharacterHasSpecialEffect(line_count=6, character=sweetling_21, special_effect=14351)
    SkipLinesIfCharacterHasSpecialEffect(line_count=5, character=sweetling_21, special_effect=14394)
    SkipLinesIfCharacterDoesNotHaveSpecialEffect(line_count=4, character=sweetling_21, special_effect=14393)
    AddSpecialEffect(sweetling_21, 14351)
    ReplanAI(sweetling_21)
    SetNetworkUpdateRate(sweetling_21, is_fixed=True, update_rate=CharacterUpdateRate.Always)
    Restart()
    SkipLinesIfCharacterDoesNotHaveSpecialEffect(line_count=7, character=sweetling_22, special_effect=14577)
    SkipLinesIfCharacterHasSpecialEffect(line_count=6, character=sweetling_22, special_effect=14351)
    SkipLinesIfCharacterHasSpecialEffect(line_count=5, character=sweetling_22, special_effect=14394)
    SkipLinesIfCharacterDoesNotHaveSpecialEffect(line_count=4, character=sweetling_22, special_effect=14393)
    AddSpecialEffect(sweetling_22, 14351)
    ReplanAI(sweetling_22)
    SetNetworkUpdateRate(sweetling_22, is_fixed=True, update_rate=CharacterUpdateRate.Always)
    Restart()

    # --- Label 10 --- #
    DefineLabel(10)
    SkipLinesIfCharacterDoesNotHaveSpecialEffect(line_count=7, character=sweetling_23, special_effect=14577)
    SkipLinesIfCharacterHasSpecialEffect(line_count=6, character=sweetling_23, special_effect=14351)
    SkipLinesIfCharacterHasSpecialEffect(line_count=5, character=sweetling_23, special_effect=14394)
    SkipLinesIfCharacterDoesNotHaveSpecialEffect(line_count=4, character=sweetling_23, special_effect=14393)
    AddSpecialEffect(sweetling_23, 14351)
    ReplanAI(sweetling_23)
    SetNetworkUpdateRate(sweetling_23, is_fixed=True, update_rate=CharacterUpdateRate.Always)
    Restart()
    SkipLinesIfCharacterDoesNotHaveSpecialEffect(line_count=6, character=sweetling_24, special_effect=14577)
    SkipLinesIfCharacterHasSpecialEffect(line_count=5, character=sweetling_24, special_effect=14351)
    SkipLinesIfCharacterHasSpecialEffect(line_count=4, character=sweetling_24, special_effect=14394)
    SkipLinesIfCharacterDoesNotHaveSpecialEffect(line_count=3, character=sweetling_24, special_effect=14393)
    AddSpecialEffect(sweetling_24, 14351)
    ReplanAI(sweetling_24)
    SetNetworkUpdateRate(sweetling_24, is_fixed=True, update_rate=CharacterUpdateRate.Always)
    Restart()
...
def Event_14003817(_, sweetlings: uint):
    """Event 14003817"""
    EndIfPlayerNotInOwnWorld()
    IfFlagEnabled(AND_1, 14003816)
    IfUnknownCharacterCondition_19(AND_1, character=sweetlings, unk_8_12=14385, unk_12_13=1, unk_13_14=4, unk_16_20=1.0)
    IfConditionTrue(MAIN, input_condition=AND_1)
    AddSpecialEffect(sweetlings, 14384)
    WaitFrames(frames=1)
    Restart()
...
def Event_14003825(_, flag: uint, rennala: uint, sweetlings: uint):
    """Event 14003825"""
    EndIfPlayerNotInOwnWorld()

    IfCharacterBackreadEnabled(AND_10, rennala)
    IfCharacterBackreadEnabled(AND_10, Characters.Sweetling1)
    IfCharacterBackreadEnabled(AND_10, Characters.Sweetling9)
    IfCharacterBackreadEnabled(AND_10, Characters.Sweetling17)
    IfFlagEnabled(AND_10, 14002805)
    AwaitConditionTrue(AND_10)
    ...
    AddSpecialEffect(Characters.Sweetling1, 14394)

    SkipLinesIfFlagDisabled(1, 14003803)
    AddSpecialEffect(Characters.Sweetling9, 14394)

    SkipLinesIfFlagDisabled(1, 14003804)
    AddSpecialEffect(Characters.Sweetling17, 14394)

    AddSpecialEffect(rennala, 14361)
    WaitFrames(frames=1)
    EnableFlag(flag)
    DisableThisSlotFlag()
    IfCharacterHasSpecialEffect(OR_1, sweetlings, 14396, target_comparison_type=ComparisonType.GreaterThanOrEqual)
...
def Event_14003880(
    ...
    WaitFrames(frames=1)
    DisableAI(Characters.RennalaBossPhase2)
    DisableAI(Characters.RennalaBossPhase2Clone)
    SetNetworkUpdateRate(CharacterGroups.Sweetlings, is_fixed=True, update_rate=CharacterUpdateRate.Never)
...
def KillRennalaGroupEntities():
    """Event 14003915"""
    IfFlagEnabled(MAIN, Flags.RennalaDefeated)
    Kill(CharacterGroups.Sweetlings)
    End()
...
def Event_14003940(_, flag: uint, wolf: uint):
    """Event 14003940"""
    IfHealthValueLessThanOrEqual(AND_1, wolf, value=1)
    IfCharacterDoesNotHaveSpecialEffect(AND_1, wolf, 14573)
    IfFlagEnabled(AND_1, flag)
    IfConditionTrue(MAIN, input_condition=AND_1)

    DisableAnimations(wolf)
    ForceAnimation(wolf, 3035, unknown2=1.0)
    Wait(5.0)
...
def Event_14003945(_, wolf: uint):
    """Event 14003945"""
    SkipLinesIfThisEventSlotFlagEnabled(2)
    DisableCharacter(wolf)
    DisableAnimations(wolf)

    IfCharacterHasSpecialEffect(AND_1, wolf, 14573)
    IfCharacterDoesNotHaveSpecialEffect(AND_1, wolf, 14574)
    IfConditionTrue(MAIN, input_condition=AND_1)

    AddSpecialEffect(wolf, 14571)
    AddSpecialEffect(wolf, 14574)
    CancelSpecialEffect(wolf, 14572)
    CancelSpecialEffect(wolf, 14576)
    DisableCharacter(wolf)
    DisableAnimations(wolf)
...
def RennalaSummonsTroll(_, troll_summoned_flag: uint, rennala: uint, troll: uint):
    """Event 14003962"""
    IfCharacterHasSpecialEffect(AND_1, rennala, 14585)
    IfFlagDisabled(AND_1, troll_summoned_flag)
    IfConditionTrue(MAIN, input_condition=AND_1)
    ...
    CancelSpecialEffect(troll, 14574)
    EnableFlag(troll_summoned_flag)
    ReplanAI(troll)
    WaitFrames(frames=1)
    ForceAnimation(troll, 20026, unknown2=1.0)
...
def RennalaDismissesTroll(_, troll_summoned_flag: uint, troll_dismissed_flag: uint, troll: uint, rennala: uint):
    """Event 14003963"""
    IfFlagDisabled(AND_1, troll_dismissed_flag)
    IfFlagEnabled(AND_1, troll_summoned_flag)
    IfCharacterHasSpecialEffect(OR_1, troll, 14572)
    IfCharacterHasSpecialEffect(OR_1, troll, 14573)
    IfConditionTrue(AND_1, input_condition=OR_1)
    IfConditionTrue(MAIN, input_condition=AND_1)

    EnableFlag(troll_dismissed_flag)
    CancelSpecialEffect(rennala, 14590)
    ReplanAI(rennala)
...
def ResetRennalaTrollSummonAbility(_, troll_summoned_flag: uint, troll_dismissed_flag: uint, rennala: uint):
    """Event 14003964"""
    IfFlagEnabled(AND_1, troll_summoned_flag)
    IfFlagEnabled(AND_1, troll_dismissed_flag)
    IfCharacterHasSpecialEffect(AND_1, rennala, 14573)
    IfConditionTrue(MAIN, input_condition=AND_1)

    DisableFlag(troll_summoned_flag)
    DisableFlag(troll_dismissed_flag)
    CancelSpecialEffect(rennala, 14573)
    Restart()


@RestartOnRest(14003965)
def Event_14003965(_, troll_summoned_flag: uint, troll: uint):
    """Event 14003965"""
    IfHealthValueLessThanOrEqual(AND_1, troll, value=1)
    IfCharacterDoesNotHaveSpecialEffect(AND_1, troll, 14573)
    IfFlagEnabled(AND_1, troll_summoned_flag)
    IfConditionTrue(MAIN, input_condition=AND_1)
    ForceAnimation(troll, 20025, unknown2=1.0)
    Wait(5.0)
    Restart()


@RestartOnRest(14003966)
def Event_14003966(_, troll: uint):
    """Event 14003966"""
    SkipLinesIfThisEventSlotFlagEnabled(2)
    DisableCharacter(troll)
    DisableAnimations(troll)

    IfCharacterHasSpecialEffect(AND_1, troll, 14573)
    IfCharacterDoesNotHaveSpecialEffect(AND_1, troll, 14574)
    IfConditionTrue(MAIN, input_condition=AND_1)

    AddSpecialEffect(troll, 14571)
    AddSpecialEffect(troll, 14574)
    CancelSpecialEffect(troll, 14572)
    CancelSpecialEffect(troll, 14573)
    CancelSpecialEffect(troll, 14576)
    DisableCharacter(troll)
    DisableAnimations(troll)
    Restart()
...
def DisableSpawnersWhenRennalaDies():
    """Event 14003978"""
    IfFlagEnabled(MAIN, Flags.RennalaDefeated)
...
def Event_14000700():
    ...
    IfFlagEnabled(AND_1, Flags.RennalaDefeated)
    IfFlagDisabled(AND_1, 3468)
    IfEntityWithinDistance(AND_1, entity=Characters.RennalaNPC1, other_entity=PLAYER, radius=10.0)
    IfConditionTrue(MAIN, input_condition=AND_1)
...
def Event_14000701():
    ...
    IfEntityWithinDistance(AND_1, entity=Characters.RennalaNPC2, other_entity=PLAYER, radius=10.0)
    IfConditionTrue(MAIN, input_condition=AND_1)
...
def Event_14000702():
    ...
    ForceAnimation(Characters.RennalaNPC1, 930010, unknown2=1.0)
    Goto(Label.L20)
    ...
    ForceAnimation(Characters.RennalaNPC2, 930010, unknown2=1.0)
    Goto(Label.L20)
