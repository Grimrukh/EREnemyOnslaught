...
from .entities.m60_51_41_00_entities import *
...
def Constructor():
    ...
    CommonFunc_NonRespawningWithReward(0, dead_flag=1051410290, character=1051410290, item_lot=40420, reward_delay=0.0, skip_reward=0, clone=0)
