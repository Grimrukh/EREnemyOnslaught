...
from .entities.m30_09_00_00_entities import *
...
def Event_30092399():
    ...
    AttachAssetToCharacter(character=Characters.MercilessChariot1, model_point=110, asset=Assets.AEG099_331_9001)
...
def Event_30092849():
    ...
    CommonFunc_HostEntersBossFog(
        0,
        boss_dead_flag=30090800,
        fog_asset=Assets.AEG099_001_9000,
        fog_region=30092800,
        host_entered_fog_flag=30092805,
        boss_characters=30095800,
    ...
    CommonFunc_SummonEntersBossFog(
        ...
        fog_region=30092800,
        host_entered_fog_flag=30092805,
        summon_entered_fog_flag=30092806,
        action_button_id=10000,
    )
    CommonFunc_ControlBossFog(0, boss_dead_flag=30090800, fog_asset=Assets.AEG099_001_9000, model_point=3, required_flag=0)
    CommonFunc_ControlBossMusic(0, 30090800, 921400, 30092805, 30092806, 0, 30092802, 0, 0)
