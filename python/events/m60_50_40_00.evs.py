...
from .entities.m60_50_40_00_entities import *
...
def Event_1050402210(
    ...
    OR_14.Add(AttackedWithDamageType(attacked_entity=character, attacker=0))
...
def Event_1050402800():
    ...
    OR_1.Add(AND_2)
    OR_1.Add(AttackedWithDamageType(attacked_entity=Characters.LargeDragonbarrowDragon, attacker=0))
    OR_1.Add(AttackedWithDamageType(attacked_entity=Characters.DragonbarrowDragon0, attacker=0))
    OR_1.Add(AttackedWithDamageType(attacked_entity=Characters.DragonbarrowDragon1, attacker=0))
    OR_1.Add(AttackedWithDamageType(attacked_entity=Characters.DragonbarrowDragon2, attacker=0))
    OR_1.Add(AttackedWithDamageType(attacked_entity=Characters.DragonbarrowDragon3, attacker=0))
    OR_1.Add(AttackedWithDamageType(attacked_entity=Characters.DragonbarrowDragon4, attacker=0))
    OR_1.Add(AttackedWithDamageType(attacked_entity=Characters.DragonbarrowDragon5, attacker=0))
    OR_1.Add(AttackedWithDamageType(attacked_entity=Characters.DragonbarrowDragon6, attacker=0))
