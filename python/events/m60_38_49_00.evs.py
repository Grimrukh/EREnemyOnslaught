...
def Constructor():
    ...
    Event_1038492320()
    Event_1038492580()
    CommonFunc_TriggerEnemyAI_WithRegion(0, character=Characters.Rat0, region=1038492302, seconds=0.0, animation_id=-1)
    CommonFunc_TriggerEnemyAI_WithRegion(0, character=Characters.Rat1, region=1038492313, seconds=0.0, animation_id=-1)
