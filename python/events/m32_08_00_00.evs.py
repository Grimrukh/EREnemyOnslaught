...
def Event_32082800():
    ...
    AND_7.Add(HealthValue(Characters.FallingstarBeast) <= 0)
    AND_7.Add(HealthValue(Characters.CLONE_FallingstarBeast) <= 0)
    MAIN.Await(AND_7)
    
    Wait(4.0)
    PlaySoundEffect(32048000, 888880000, sound_type=SoundType.s_SFX)
    
    AND_8.Add(CharacterDead(Characters.FallingstarBeast))
    AND_8.Add(CharacterDead(Characters.CLONE_FallingstarBeast))
    MAIN.Await(AND_8)
...
def Event_32082849():
    ...
    CommonFunc_ControlBossFog(0, boss_dead_flag=32080800, fog_asset=Assets.AEG099_003_9000, model_point=7, required_flag=32080801)
