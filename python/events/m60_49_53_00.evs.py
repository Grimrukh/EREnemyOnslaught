...
def Constructor():
    ...
    CommonFunc_TriggerEnemyAI_WithRegionOrRadius(0, character=Characters.Springhare0, region=1049532260, radius=1.0, seconds=0.0, animation_id=0)
    CommonFunc_TriggerEnemyAI_WithRegionOrRadius(0, character=Characters.Springhare1, region=1049532261, radius=1.0, seconds=0.0, animation_id=0)
    CommonFunc_TriggerEnemyAI_WithRegionOrRadius(0, character=Characters.Springhare2, region=1049532262, radius=1.0, seconds=0.0, animation_id=0)
