...
def Constructor():
    ...
    Event_1035472200()
    Event_1035472210()
    CommonFunc_NonRespawningWithReward(0, dead_flag=1035470200, character=Characters.Turtle0, item_lot=0, reward_delay=0.0, skip_reward=0, clone=0)
    CommonFunc_NonRespawningWithReward(0, dead_flag=1035470201, character=Characters.Turtle1, item_lot=0, reward_delay=0.0, skip_reward=0, clone=0)
    CommonFunc_NonRespawningWithReward(0, dead_flag=1035470202, character=Characters.Turtle2, item_lot=0, reward_delay=0.0, skip_reward=0, clone=0)
    CommonFunc_NonRespawningWithReward(0, dead_flag=1035470220, character=Characters.Scarab1, item_lot=0, reward_delay=0.0, skip_reward=0, clone=0)
    Event_1035472240(
        0,
    ...
    CommonFunc_NonRespawningWithReward(0, dead_flag=1035470260, character=Characters.Scarab0, item_lot=40210, reward_delay=0.0, skip_reward=0, clone=0)
    Event_1035472270()
...
def Preconstructor():
    """Event 50"""
    CommonFunc_TriggerEnemyAI_WithRadius(0, character=Characters.Turtle1, radius=3.0, seconds=0.0, animation_id=0)
    CommonFunc_TriggerEnemyAI_WithRadius(0, character=Characters.Turtle2, radius=3.0, seconds=0.0, animation_id=0)
    CommonFunc_TriggerEnemyAI_WithRadius(0, character=Characters.PutridCorpse0, radius=3.0, seconds=0.0, animation_id=0)
    CommonFunc_TriggerEnemyAI_WithRadius(0, character=Characters.PutridCorpse1, radius=3.0, seconds=0.0, animation_id=0)
    CommonFunc_TriggerEnemyAI_WithRadius(0, character=Characters.PutridCorpse2, radius=3.0, seconds=0.0, animation_id=0)
    CommonFunc_TriggerEnemyAI_WithRadius(0, 1035470218, 3.0, 0.0, 0)
