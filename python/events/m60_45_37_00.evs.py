...
from .entities.m60_45_37_00_entities import *
...
def Constructor():
    ...
    Event_1045372344()
    CommonFunc_NonRespawningWithReward(0, dead_flag=1045370200, character=Characters.Scarab, item_lot=40116, reward_delay=0.0, skip_reward=0, clone=0)
