...
from .entities.m60_47_39_00_entities import *
...
def Constructor():
    ...
    CommonFunc_NonRespawningWithReward(0, dead_flag=1047390299, character=Characters.Scarab0, item_lot=40410, reward_delay=0.0, skip_reward=0, clone=0)
    CommonFunc_NonRespawningWithReward(0, dead_flag=1047390298, character=Characters.Scarab1, item_lot=40422, reward_delay=0.0, skip_reward=0, clone=0)
