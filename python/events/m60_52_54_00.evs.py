...
def Constructor():
    ...
    CommonFunc_NonRespawningWithReward(0, dead_flag=1052540491, character=Characters.SnowTroll0, item_lot=0, reward_delay=0.0, skip_reward=0, clone=0)
    CommonFunc_NonRespawningWithReward(0, dead_flag=1052540492, character=Characters.SnowTroll1, item_lot=0, reward_delay=0.0, skip_reward=0, clone=0)
    CommonFunc_NonRespawningWithReward(0, dead_flag=1052540494, character=Characters.SnowTroll2, item_lot=0, reward_delay=0.0, skip_reward=0, clone=0)
