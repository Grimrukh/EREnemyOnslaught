...
def Constructor():
    ...
    CommonFunc_NonRespawningWithReward(0, dead_flag=1048380290, character=Characters.Scarab, item_lot=40402, reward_delay=0.0, skip_reward=0, clone=0)
    Event_1048382201()
    ...
    CommonFunc_TriggerEnemyAI_WithRegion(0, character=1048380300, region=1048382300, seconds=0.0, animation_id=-1)
    CommonFunc_90005725(
        0,
        flag=4775,
        flag_1=4776,
    ...
    CommonFunc_MakeNPCHostile(0, npc=Characters.Merchant, flag=4776, required_flag=4775, hostile_flag=1048389206, hostile_hits=3)
    ...
    CommonFunc_MakeNPCHostile(0, npc=Characters.NomadMule, flag=4776, required_flag=4775, hostile_flag=1048389207, hostile_hits=3)
