...
from .entities.m60_43_38_00_entities import *
...
def Constructor():
    ...
    CommonFunc_TriggerEnemyAI_WithRadius(0, character=Characters.KaidenSellsword, radius=10.0, seconds=0.0, animation_id=-1)
