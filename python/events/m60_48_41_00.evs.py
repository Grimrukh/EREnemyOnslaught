...
def Constructor():
    ...
    CommonFunc_NonRespawningWithReward(0, dead_flag=1048410290, character=Characters.Scarab, item_lot_param_id=40412, reward_delay=0.0, skip_reward=0)
    CommonFunc_90005760(
        0,
        flag=1048410800,
    ...
    CommonFunc_90005860(
        ...
        character=Characters.BellBearingHunter,
        left_1=0,
        item_lot__item_lot_param_id=1048410800,
        seconds=0.0,
    )
