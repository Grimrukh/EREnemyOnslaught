...
def Constructor():
    ...
    CommonFunc_MakeNPCHostile(0, npc=Characters.Merchant, flag=4791, required_flag=4790, hostile_flag=1048410702, hostile_hits=3)
    ...
    CommonFunc_MakeNPCHostile(0, 1048410701, 4791, 4790, 1048410702, 3)
