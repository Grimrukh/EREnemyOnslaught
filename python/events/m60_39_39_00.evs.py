...
def Constructor():
    """Event 0"""
    CommonFunc_MakeNPCHostile(0, npc=Characters.SorcererThops, flag=3801, required_flag=3800, hostile_flag=1039399201, hostile_hits=3)
    CommonFunc_90005703(
        0,
    ...
    CommonFunc_NonRespawningWithReward(0, dead_flag=1039390200, character=Characters.Scarab, item_lot=40206, reward_delay=0.0, skip_reward=0, clone=0)
    Event_1039392200()
