...
from .entities.m60_45_36_00_entities import *
from .entities.m60_45_36_10_entities import Characters as m60_45_Characters
...
def Constructor():
    ...
    CommonFunc_90005463(0, character=1045362212, character_1=Characters.GiantOctopus)
    CommonFunc_90005464(0, flag=1045362212, character=Characters.GiantOctopus, character_1=Characters.Octopus0, value=0)
    CommonFunc_90005464(0, flag=1045362212, character=Characters.GiantOctopus, character_1=Characters.Octopus1, value=1)
    CommonFunc_90005464(0, flag=1045362212, character=Characters.GiantOctopus, character_1=Characters.Octopus2, value=2)
    CommonFunc_90005464(0, flag=1045362212, character=Characters.GiantOctopus, character_1=Characters.Octopus3, value=3)
    CommonFunc_90005464(0, flag=1045362212, character=Characters.GiantOctopus, character_1=Characters.Octopus4, value=4)
    Event_1045362200()
    Event_1045362400()
    CommonFunc_90005725(
        0,
    ...
    CommonFunc_MakeNPCHostile(0, npc=Characters.Merchant, flag=4726, required_flag=4725, hostile_flag=1045369306, hostile_hits=3)
    ...
    CommonFunc_MakeNPCHostile(0, npc=Characters.NomadMule, flag=4726, required_flag=4725, hostile_flag=1045369307, hostile_hits=3)
    ...
    CommonFunc_MakeNPCHostile(0, npc=Characters.TalkDummy1, flag=4726, required_flag=4725, hostile_flag=1045369306, hostile_hits=3)
    CommonFunc_90005702(0, character=Characters.TalkDummy1, flag=4728, first_flag=4725, last_flag=4729)
    CommonFunc_90005703(
        0,
    ...
    CommonFunc_MakeNPCHostile(
        0,
        npc=m60_45_Characters.NomadMule,
        flag=4726,
        required_flag=4725,
        hostile_flag=1045369307,
        hostile_hits=3,
    )
    ...
    CommonFunc_90005729(0, flag=1045369300, character=Characters.TalkDummy1, distance=40.0, flag_1=1045362702)
    CommonFunc_90005706(0, character=Characters.WanderingNoble, animation_id=930023, left=0)
    Event_1045363704()
    CommonFunc_90005706(0, character=Characters.WanderingNoble, animation_id=30023, left=0)
    Event_1045363715()
...
def Event_1045362200():
    """Event 1045362200"""
    AddSpecialEffect(Characters.GiantOctopus, 11771)
...
def Event_1045363704():
    ...
    MAIN.Await(EntityWithinDistance(entity=PLAYER, other_entity=Characters.Merchant, radius=7.5))
