...
def Constructor():
    ...
    CommonFunc_TriggerEnemyAI_WithRegion(0, character=Characters.GuardianGolem, region=1051402300, seconds=0.0, animation_id=-1)
    CommonFunc_TriggerEnemyAI_WithRadius(0, 1051400300, 7.0, 0.0, -1)
