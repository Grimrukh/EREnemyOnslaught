...
def Event_11100031():
    """Event 11100031"""
    if FlagDisabled(CommonFlags.EndingDone):
        return
    if FlagEnabled(CommonFlags.ReturnedToRoundtableAfterEnding):
        return
    AND_1.Add(PlayerInOwnWorld())
    AND_1.Add(FlagEnabled(CommonFlags.EndingDone))
    
    MAIN.Await(AND_1)
    
    DisableFlag(71900)
    EnableFlag(CommonFlags.ReturnedToRoundtableAfterEnding)
