...
def Preconstructor():
    ...
    CommonFunc_TriggerInactiveEnemy_WithRegionOrRadius(0, 30010311, 30000, 20000, 30012322, 5.0, 3.9000000953674316, 0, 0, 0, 0)
...
def Event_30012849():
    ...
    CommonFunc_ControlBossFog(0, boss_dead_flag=30010800, fog_asset=Assets.AEG099_001_9000, model_point=3, required_flag=0)
