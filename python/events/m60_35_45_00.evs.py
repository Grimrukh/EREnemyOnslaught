...
def Constructor():
    ...
    CommonFunc_MakeNPCHostile(0, npc=Characters.Merchant, flag=4751, required_flag=4750, hostile_flag=1035459206, hostile_hits=3)
    ...
    CommonFunc_MakeNPCHostile(0, npc=Characters.NomadMule, flag=4751, required_flag=4750, hostile_flag=1035459207, hostile_hits=3)
...
def Preconstructor():
    ...
    CommonFunc_TriggerEnemyAI_WithRadius(0, character=Characters.WolfPackLeader, radius=10.0, seconds=0.0, animation_id=3011)
    CommonFunc_TriggerInactiveEnemy_WithRegionOrRadius(0, 1035450210, 30002, 20002, 1035452210, 3.0, 0.0, 0, 0, 0, 0)
