...
from .entities.m60_52_55_00_entities import *
...
def Event_1052552270(
    ...
    OR_3.Add(HealthRatio(Characters.ChiefGuardianArghanthy) <= 0.550000011920929)
    AND_1.Add(OR_3)
...
@ContinueOnRest(1052552580)
def Event_1052552580():
    """Event 1052552580"""
    RegisterLadder(start_climbing_flag=1052550580, stop_climbing_flag=1052550851, asset=Assets.AEG030_902_2000)
    RegisterLadder(start_climbing_flag=1052550582, stop_climbing_flag=1052550853, asset=Assets.AEG030_934_2000)
