...
def Constructor():
    ...
    CommonFunc_TriggerEnemyAI_WithRegion(0, character=Characters.PutridCorpseBare, region=1046402303, seconds=0.0, animation_id=-1)
    CommonFunc_TriggerEnemyAI_WithRegion(0, character=Characters.PutridCorpse0, region=1046402301, seconds=0.0, animation_id=-1)
    CommonFunc_TriggerEnemyAI_WithRegion(0, character=Characters.PutridCorpse1, region=1046402303, seconds=0.0, animation_id=-1)
    CommonFunc_TriggerEnemyAI_WithRegion(0, character=Characters.PutridCorpse2, region=1046402303, seconds=0.0, animation_id=-1)
    CommonFunc_TriggerEnemyAI_WithRadius(0, character=Characters.LivingMass, radius=2.0, seconds=0.0, animation_id=-1)
