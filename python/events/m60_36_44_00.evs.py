...
def Constructor():
    ...
    CommonFunc_NonRespawningWithReward(
        0, dead_flag=1036440250, character=Characters.Scarab, item_lot=40202, reward_delay=0.0, skip_reward=0, clone=0
    )
    CommonFunc_NonRespawningWithReward(
        0, dead_flag=1036440260, character=1036440260, item_lot=1036440200, reward_delay=0.0, skip_reward=0, clone=0
    )
...
def Preconstructor():
    ...
    CommonFunc_TriggerEnemyAI_WithRegionOrRadius(0, character=1036440231, region=1036442220, radius=10.0, seconds=0.0, animation_id=-1)
    CommonFunc_TriggerEnemyAI_WithRadius(0, character=Characters.RayaLucariaSoldier0, radius=15.0, seconds=0.0, animation_id=0)
    CommonFunc_TriggerEnemyAI_WithRadius(0, 1036440242, 15.0, 0.0, 0)
