...
def Constructor():
    ...
    CommonFunc_TriggerEnemyAI_WithRegionOrRadius(
        0,
        character=Characters.CLONE_TibiaMariner,
        region=1038522300,
        radius=30.0,
        seconds=0.0,
        animation_id=-1,
    ...
    CommonFunc_TriggerEnemyAI_WithRegionOrRadius(
        1,
        character=Characters.CLONE_GiantSkeletonTorso,
        region=1038522300,
        radius=20.0,
        seconds=0.0,
        animation_id=-1,
    ...
    Event_1038522347(
        ...
        region=1038522400,
        flag=1038520800,
        event_target_character=Characters.GiantSkeletonTorso,
    )
    Event_1038522347(
        1,
        character=Characters.GiantSkeletonTorso,
        region=1038522400,
        flag=1038520800,
        event_target_character=Characters.TibiaMariner,
    )
    CommonFunc_FieldBossMusicHealthBar(
        0, boss=Characters.TibiaMariner, name=904950602, npc_threat_level=24,
    ...
    Event_1038522339(0, character=1038520340, character_1=1038520350)
    Event_1038522349()
...
def Event_1038522347(
    ...
    region: uint,
    flag: uint,
    event_target_character: uint,
):
    """Event 1038522347"""
    DisableNetworkSync()
    if FlagEnabled(flag):
        return
    AND_1.Add(CharacterTargeting(targeting_character=character, targeted_character=20000))
    ...
    Wait(1.0)
    SetCharacterEventTarget(character, entity=event_target_character)
    SetCharacterEventTarget(event_target_character, entity=character)
    Wait(5.0)
    Restart()
