...
def Constructor():
    ...
    CommonFunc_MakeNPCHostile(0, npc=Characters.BrotherCorhyn, flag=4201, required_flag=4200, hostile_flag=1040549201, hostile_hits=3)
    CommonFunc_90005703(
        0,
...
def Preconstructor():
    ...
    CommonFunc_TriggerEnemyAI_WithRegionOrRadius(0, character=1040540270, region=1040542270, radius=20.0, seconds=0.0, animation_id=0)
    ...
    CommonFunc_TriggerEnemyAI_WithRadius(0, character=1040540340, radius=0.0, seconds=0.0, animation_id=-1)
    CommonFunc_TriggerInactiveEnemy_WithRadius(0, 1040540402, 30000, 20000, 10.0, 0.0, 0, 0, 0, 0)
