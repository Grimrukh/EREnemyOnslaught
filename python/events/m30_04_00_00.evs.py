...
def Preconstructor():
    ...
    CommonFunc_TriggerInactiveEnemy_WithRegion(
        ...
        trigger_region=30042200,
        trigger_delay=0.0,
        disable_gravity_and_collision=1,
    ...
    CommonFunc_TriggerEnemyAI_WithRegionOrRadius(0, character=Characters.Imp5, region=30042207, radius=1.0, seconds=0.0, animation_id=3004)
    CommonFunc_TriggerInactiveEnemy_WithRegion(
        0,
        character=Characters.Imp6,
        inactive_animation=30010,
        active_animation=20010,
        trigger_region=30042210,
        trigger_delay=0.0,
        disable_gravity_and_collision=0,
        trigger_on_ai_battle=0,
        trigger_on_ai_unknown5=0,
...
def Event_30042810():
    ...
    EnableBossHealthBar(Characters.GraveWardenDuelist, name=903400300, bar_slot=1)
    EnableBossHealthBar(Characters.CLONE_GraveWardenDuelist, name=903400300, bar_slot=0)
...
def Event_30042849():
    ...
    CommonFunc_ControlBossFog(0, boss_dead_flag=30040800, fog_asset=Assets.AEG099_001_9000, model_point=3, required_flag=0)
