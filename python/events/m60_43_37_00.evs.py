...
from .entities.m60_43_37_00_entities import *
from .entities.m60_43_39_00_entities import Characters as m60_43_Characters
...
def Constructor():
    ...
    CommonFunc_NonRespawningWithReward(0, dead_flag=1043370210, character=Characters.Scarab, item_lot=40108, reward_delay=0.0, skip_reward=0)
...
def Event_1043373700(_, character: uint, character_1: uint, character_2: uint, asset: uint):
    """Event 1043373700"""
    WaitFrames(frames=1)
...
def Event_1043373722(_, character: uint, region: uint, region_1: uint, region_2: uint, region_3: uint):
    """Event 1043373722"""
    if PlayerNotInOwnWorld():
        return
    if FlagEnabled(1043379262):
...
def Event_1043373730(_, character: uint, asset: uint):
    """Event 1043373730"""
    DisableNetworkSync()
    WaitFrames(frames=1)
